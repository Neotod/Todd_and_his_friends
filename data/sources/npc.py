...
class Healer(pygame.sprite.Sprite):
    def __init__(self):
        ...
        folder_path = r'data\images\characters\healer\idle'
        ...
        folder_path = r'data\images\characters\healer\hurted'
    ...
    def show_health(self, display):
        ...
        image_path = r'data\images\characters\healer\health_bar\\' + str(health_num) + '.png'
    ...
    def heal(self, player):
        ...
        file_path = r'data\sounds\sfx\player\heal.wav'
    ...
    def collide_enemy(self, enemy_name):
        ...
        file_path = r'data\sounds\sfx\npc\healer\got_hit.wav'
...
class Alchemist(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        folder_path = r'data\images\characters\alchemist'
